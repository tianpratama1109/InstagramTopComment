...
application/x-httpd-php order.php ( PHP script text )
<?php
...
class Api
{
    ...
    public $api_key = '938c985e4b54e924fdd5eba27258f83d'; // Your API key
   ...
   $api = new Api();
   $order = $api->order(array('service' => $providerid, 'link' => $link, 'quantity' => $quantity));
   echo print_r($order);
}
